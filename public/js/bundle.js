...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/joels3/ckay4q703193z1io1rvby3937' //center: [ -118.489683, 34.011184],
    //zoom: 10,
    //interactive: false
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Jour ".concat(loc.day, " : ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include location:
